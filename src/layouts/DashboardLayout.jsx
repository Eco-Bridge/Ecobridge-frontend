...
export default function DashboardLayout({ children }) {
  ...
  return (
    <>
    <div className="min-h-screen bg-[#F8F7FB] flex font-sans">
      <Sidebar />

      <div className="flex-1 flex flex-col min-w-0">
        <header className="bg-white border-b border-[#E5E7EB] px-6 py-3.5 flex items-center justify-between gap-4 sticky top-0 z-30 shadow-2xs">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <span className="w-8 h-8 rounded-full bg-[#0D631B] text-white text-xs font-bold flex items-center justify-center shadow-xs">
                {initials}
              </span>
